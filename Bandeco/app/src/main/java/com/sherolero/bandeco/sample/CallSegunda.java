 ...
 */
public class CallSegunda extends BaseFragment implements View.OnClickListener{
    static final String TAG = "tag.CallSegunda";
    ...
    public static CallSegunda newInstance() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle sis) {
        ...
        final CardapioListAdapter adapter = new CardapioListAdapter(getActivity(), 0, 0);
        adapterAlmoco = adapter;
        final CardapioListAdapter adapter1 = new CardapioListAdapter(getActivity(), 1, 1);
        adapterJanta = adapter1;

        mListView = findView(view, R.id.list_view_cardapio);

        mListView.setAdapter(adapter);      // Abre no Almoco
        ...
        switch (MainActivity.diaSemana){
            case 1:
                data = MainActivity.getOtherDates(c, -6);
