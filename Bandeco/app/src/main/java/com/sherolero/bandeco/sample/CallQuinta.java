 ...
 */
public class CallQuinta extends BaseFragment implements View.OnClickListener{
    ...
    public static CallQuinta newInstance() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent, Bundle sis) {
        ...
        final CardapioListAdapter adapter = new CardapioListAdapter(getActivity(), 6, 0);
        adapterAlmoco = adapter;
        final CardapioListAdapter adapter1 = new CardapioListAdapter(getActivity(), 7, 1);
